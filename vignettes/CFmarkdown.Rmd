...
date: "`r Sys.Date()`"
bibliography: "/Users/PJO/Desktop/Basic/doc/CF.bib"
...
```{r brownian.motion, echo = FALSE, fig.height=4, fig.show='animate', fig.width=4, dev='jpeg', ffmpeg.format='gif'}
library(animation)
...
```{r cfanim, echo = FALSE, fig.show='animate', ffmpeg.format='gif', dev='jpeg', fig.height = 4, fig.width = 6, message = FALSE, warning = FALSE}
library(animation)
library(dplyr)
library(gganimate)
library(gapminder)
...
```{r echo = FALSE,  fig.height = 18, fig.width = 6}
library(shiny)
...
```{r, fig.show = 'animate', ffmpeg.format ='gif', dev = 'jpeg', echo = FALSE, fig.height = 4, fig.width = 6, message = FALSE, warning = FALSE}
library(animation)
library(dplyr)
library(gganimate)
library(gapminder)
...
```{r, as.is = TRUE, echo = FALSE, fig.height = 4, fig.width = 6, message = FALSE, warning = FALSE}
library(knitr)
...
$K_t$ is a stochastic differential equation model of traffic density by _time-of-day_ $t$ [@pjo2017]. Treating traffic density $K_t$ as the random variable  may seem contradictory given the discussion about the $Q = k * U(t)$ model. It is not. Note that two models are different. One is a _macroscale_ model predicting breakdown and the other one is a _microscale_ model predicting flow.  
