...
```{r speedplot, echo = FALSE, fig.height = 4, fig.width = 6, message=FALSE, error=FALSE, warning = FALSE}
library(dplyr)
library(ggplot2)
speedplot(QUKtdayX)
```
...
```{r speedboxplot, echo = FALSE, fig.height = 4, fig.width = 6, message=FALSE, error=FALSE, warning = FALSE}
library(dplyr)
library(ggplot2)
...
```{r speedtsplot, echo = FALSE, fig.height = 4, fig.width = 6, message=FALSE, error=FALSE, warning = FALSE}
library(dplyr)
library(ggplot2)
speedtsplot(speedts)
```
