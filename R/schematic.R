...
schematic <- function() {
  ...
  axis(side = 2, at = -500, labels = expression(x[e]*" = -500"))
  axis(side = 2, at = 0, labels = expression(x[0]*" = 0"))
  text(15,0, label = "Bottleneck", pos = 3)
  text(15,-250, label = "Merge Zone", pos = 3)
  title(main = "")
  axis(side = 1, at = 0, labels = "Upstream", line = 1.5, cex = 2)
  axis(side = 3, at = 0, labels = "Downstream", line = 1.5, cex = 2)
}
